...
export default function About() {
  ...
  return (
    <div className={`${Number(windowHeight) < 990 ? '': 'display-flex' } marg-per-t-4 col-md-12 col-xs-12 col-sm-12 col-lg-12 col-xxl-12 col-xl-12`} >
      ...
      <div className={`${Number(windowHeight) < 990 ? 'marg-per-l-4 col-md-12 col-lg-12 col-xxl-12 col-xl-12' : ' col-md-6 col-lg-6 col-xxl-6 col-xl-6' } col-xs-12 col-sm-12  ht-pc-40 border-all-px-2 border-radius-px-10 border-color-grey`}>
              {
                          ...
                          {article.youTubeVideo ? (
                                ...
                                <YouTube
                                  ...
                                  opts={{
                                    ...
                                    width:  `${Number(windowHeight) < 990 ? String((window.innerWidth / 0.5 )) : String((window.innerWidth / 2.0))}`,
                                    playerVars: { autoplay: 0 },
                                  }}
                                />
                              ) : (
